...
print(lvns.density(df_normalized, "엄신"))
print(lvns.density(df_normalized, "ㅎㅎㅈㅅ"))
lvns.show_word_count(df_normalized, 'ㅋㅋ', diff= True, highlight=True, scaler='M')
...
df_relation_score = lvns.relation_score(df_normalized)
print(df_relation_score)
